...
| `coreaudio_volume.py` | ctypes wrapper around CoreAudio's AudioObject API for macOS hardware device volume. **Currently unused** — macOS players use software volume (see Volume Control above) |
